...
public class Video implements Serializable {
    ...
    public Video(@NonNull String id, String url, String title, Owner owner, String date, int views, int likes, int dislikes, String thumbnail, String description, String duration, List<CommentObj> comments) {
        this.id = id;
        this.url = url;
        this.title = title;
        this.owner = owner;
